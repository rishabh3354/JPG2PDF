...
class Ui_AppSettings(object):
    def setupUi(self, AppSettings):
        ...
        self.text_size = QtWidgets.QSpinBox(self.groupBox_8)
        self.text_size.setObjectName("text_size")
        self.gridLayout_26.addWidget(self.text_size, 0, 1, 1, 1)
    ...
    def retranslateUi(self, AppSettings):
        ...
        self.groupBox_8.setTitle(_translate("AppSettings", "File Explorer"))
        self.label_2.setText(_translate("AppSettings", "Text size"))

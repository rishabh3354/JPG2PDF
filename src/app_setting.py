...
class Ui_AppSettings(object):
    def setupUi(self, AppSettings):
        ...
        self.gridLayout_27.addWidget(self.okay, 0, 1, 1, 1)
    ...
    def retranslateUi(self, AppSettings):
        ...
        self.groupBox_10.setTitle(_translate("AppSettings", "Import image folder filter"))
        ...
        self.okay.setText(_translate("AppSettings", "Okay"))

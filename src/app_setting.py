...
class Ui_AppSettings(object):
    def setupUi(self, AppSettings):
        ...
        self.groupBox_9 = QtWidgets.QGroupBox(AppSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_11 = QtWidgets.QGroupBox(AppSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_8 = QtWidgets.QGroupBox(AppSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(AppSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, AppSettings):
        ...
        self.groupBox_9.setTitle(_translate("AppSettings", "Destination path"))
        ...
        self.groupBox_11.setTitle(_translate("AppSettings", "Default import directory"))
        self.label_3.setText(_translate("AppSettings", "Import path"))
        self.change_import.setText(_translate("AppSettings", "Change"))
        self.groupBox_8.setTitle(_translate("AppSettings", "Image icon"))
        self.label_2.setText(_translate("AppSettings", "icon size"))
        self.groupBox_5.setTitle(_translate("AppSettings", "File Dialog setting"))
        ...
        self.groupBox_10.setTitle(_translate("AppSettings", "Import image filter"))
        ...
        self.close.setText(_translate("AppSettings", "Close"))

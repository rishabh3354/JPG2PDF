...
class Ui_AdvanceSettings(object):
    def setupUi(self, AdvanceSettings):
        ...
        AdvanceSettings.resize(527, 866)
        ...
        self.size_value = QtWidgets.QSpinBox(self.groupBox_9)
        self.size_value.setObjectName("size_value")
        self.gridLayout_28.addWidget(self.size_value, 2, 2, 1, 1)
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(AdvanceSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, AdvanceSettings):
        ...
        self.label_26.setText(_translate("AdvanceSettings", "Image size"))
        self.image_size_unit.setText(_translate("AdvanceSettings", "Unit in (mm)"))
        self.size_value.setToolTip(_translate("AdvanceSettings", "Image size"))

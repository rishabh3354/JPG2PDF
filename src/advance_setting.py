...
class Ui_AdvanceSettings(object):
    def setupUi(self, AdvanceSettings):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 550, 928))
        ...
        self.gridLayout_26.addWidget(self.clear_all_settings, 0, 1, 1, 1)
        self.okay = QtWidgets.QPushButton(self.groupBox_6)
        self.okay.setObjectName("okay")
        self.gridLayout_26.addWidget(self.okay, 0, 3, 1, 1)

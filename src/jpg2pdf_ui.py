...
"}")
        ...
        self.actionAccount.setIcon(icon20)
        self.actionAccount.setObjectName("actionAccount")
        self.actionClear_all = QtWidgets.QAction(MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/myresource/resource/icons8-delete-bin-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionClear_all.setIcon(icon21)
        self.actionClear_all.setObjectName("actionClear_all")
        self.actionRemove_Selected = QtWidgets.QAction(MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/myresource/resource/icons8-multiply-52.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_Selected.setIcon(icon22)
